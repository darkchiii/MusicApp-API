...
class Artist(models.Model):
    ...
    listeners_counter = models.PositiveBigIntegerField(blank=False, default=0)
    def __str__(self):
        return self.name
...
class Played(models.Model):
    ...
    track = models.ForeignKey(Track, on_delete=models.CASCADE, related_name='tracks_played')
    played_date = models.DateTimeField(blank=False, auto_now=True)
    def __str__(self):
        return self.track.title
    
class Liked(models.Model):
    track = models.ForeignKey(Track, on_delete=models.CASCADE,  related_name='tracks_liked')
